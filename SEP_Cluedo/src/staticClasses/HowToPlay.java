...
public class HowToPlay {
	...
	public static final String PLAY = "PLAY: \nTurns continue clockwise around the table. "
	...
	public static final String CREATE_SERVER = "JOIN/CREATE SERVER: \nYou have to join or create a server first to start a game. "
			+ "Click on the 'Create Server', then join the server by double-clicking it or double click on an existing server in the Serverlist at the top left corner. \n\n";
	
	
	
	public static final String CREATE_GAME = "JOIN/CREATE GAME: \nClick on 'Create Game' to create a new game or "
			+ "join a game by double-clicking an existing game in the Gameslist at the bottom right corner. You can only start a game after you have joined a server. \n\n";
		
	
	
	public static final String LOBBY_CHAT = "LOBBY CHAT: \nType in your message in the bottom left corner. Send them with ENTER. \n\n";
	
	
	
	public static final String PRIVATE_CHAT = "PRIVATE CHAT: \nDouble-click on the nick of the playername of the player "
			+ "you want to chat with to open up the chat window. Send your messages with ENTER. All messages are displayed in the lobby chat window. \n\n";
