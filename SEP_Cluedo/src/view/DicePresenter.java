...
public class DicePresenter {
	...
	public DicePresenter(DiceView dices, GameFrameView view, Ausloeser ausloeser, BoardView gui, Sucher sucher, PlayerCircleManager pcManager, KachelContainer kacheln){
