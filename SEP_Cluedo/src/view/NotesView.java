...
public class NotesView extends TabPane {
	...
	public NotesView(CluedoGameClient client){
		...
		checklist.closableProperty().setValue(false);
		this.setTabMaxHeight(30);
		this.setTabMinHeight(30);
		
		this.userNotes = new Tab("User Notes");
		userNotes.closableProperty().setValue(false);
		...
		layoutGrid.setVgap(1);
		layoutGrid.setHgap(1);
		
		ColumnConstraints col0 = new ColumnConstraints();
        col0.setPercentWidth(27.888);
        layoutGrid.getColumnConstraints().add(col0);
        ColumnConstraints col1 = new ColumnConstraints();
        col1.setPercentWidth(16.559);
        layoutGrid.getColumnConstraints().add(col1);
        ColumnConstraints col2 = new ColumnConstraints();
        col2.setPercentWidth(59.322);
        layoutGrid.getColumnConstraints().add(col2);
		 
        RowConstraints row0 = new RowConstraints();
		row0.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row0);
		RowConstraints row1 = new RowConstraints();
		row1.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row1);
		RowConstraints row2 = new RowConstraints();
		row2.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row2);
		RowConstraints row3 = new RowConstraints();
		row3.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row3);
		RowConstraints row4 = new RowConstraints();
		row4.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row4);
		RowConstraints row5 = new RowConstraints();
		row5.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row5);
		RowConstraints row6 = new RowConstraints();
		row6.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row6);
		RowConstraints row7 = new RowConstraints();
		row7.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row7);
		RowConstraints row8 = new RowConstraints();
		row8.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row8);
		RowConstraints row9 = new RowConstraints();
		row9.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row9);
		RowConstraints row10 = new RowConstraints();
		row10.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row10);
		RowConstraints row11 = new RowConstraints();
		row11.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row11);
		RowConstraints row12 = new RowConstraints();
		row12.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row12);
		RowConstraints row13 = new RowConstraints();
		row13.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row13);
		RowConstraints row14 = new RowConstraints();
		row14.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row14);
		RowConstraints row15 = new RowConstraints();
		row15.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row15);
		RowConstraints row16 = new RowConstraints();
		row16.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row16);
		RowConstraints row17 = new RowConstraints();
		row17.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row17);
		RowConstraints row18 = new RowConstraints();
		row18.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row18);
		RowConstraints row19 = new RowConstraints();
		row19.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row19);
		RowConstraints row20 = new RowConstraints();
		row20.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row20);
		RowConstraints row21 = new RowConstraints();
		row21.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row21);
		RowConstraints row22 = new RowConstraints();
		row22.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row22);
		RowConstraints row23 = new RowConstraints();
		row23.setPercentHeight(4.166666666); 
		layoutGrid.getRowConstraints().add(row23);
		...
		for(TextField t : textFlds){
			t.setFont(Font.font("Tahoma", FontWeight.NORMAL, 12));
		}
	...
	public void editSize(){
		...
		for(Button button : buttons){
			button.setMaxSize(45, 25);
			button.setMinSize(45, 25);
			button.setPrefSize(45, 25);
		...
		for(TextField txtField : textFlds){
			txtField.setMaxHeight(25);
			txtField.setMinHeight(25);
			txtField.setPrefHeight(25);
			txtField.setMaxWidth(135);
			txtField.setOpacity(0.8);
			txtField.setBackground(defaultTxt);
			txtField.setBorder(defaultBorder);
		}
		
		for(Label lbl : labels){
			lbl.setFont(Font.font("Tahoma", FontWeight.NORMAL, 12.5));
		}
