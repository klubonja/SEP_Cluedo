...
public class WahnsinnigTollerPathfinder {
	...
	private Kachel [] suchKacheln = new Kachel [20];
	...
	private int [] xPositionen = new int [20];
	private int [] yPositionen = new int [20];
	
	private char [][][] mehrereMoeglichkeiten = new char [20][1000][12];
